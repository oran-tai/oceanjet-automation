...
def main():
    ...
    # 1. Booking with fake accommodation "XX" should raise ACCOMMODATION_UNAVAILABLE
    logger.info("")
    ...
    try:
        ...
        if e.error_code == TicketErrorCode.ACCOMMODATION_UNAVAILABLE:
            ...
            logger.error(f"FAIL: Expected ACCOMMODATION_UNAVAILABLE, got {e.error_code.value}")
            sys.exit(1)
